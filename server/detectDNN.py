...
## PYTHON APP: python detectDNN.py -p Caffe/SSD_MobileNet_prototxt.txt -m Caffe/SSD_MobileNet.caffemodel
...
ap.add_argument(
    ...
    required=True,
    help=
    '/Caffe/SSD_MobileNet_prototxt.txt'
)
ap.add_argument(
    "-m",
    "--model",
    required=True,
    help=
    '/Caffe/SSD_MobileNet.caffemodel'
)
