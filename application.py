...
# prototxtPath = os.path.dirname(os.path.abspath('application.py')) + '/server/Caffe/SSD_MobileNet_prototxt.txt'
# modelPath = os.path.dirname(os.path.abspath('application.py')) + '/server/Caffe/SSD_MobileNet.caffemodel'
